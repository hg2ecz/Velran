...
# Secure Notes checkpoint: 09-json-api

**Chapter 9 JSON API boundary.**

Keep the Secure Notes HTML application intact and study its API boundary through the canonical typed JSON companions.
