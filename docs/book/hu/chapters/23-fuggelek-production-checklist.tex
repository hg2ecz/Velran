...
A repository teljes mintája: \code{examples/systemd/velran.service}. A lényegi forma:
...
\begin{enumerate}
  ...
  \item \textbf{Erőforrások:} request/runtime limitek és process hard limitek konzisztensen be vannak állítva; cgroup authorityként systemd vagy külön delegált Velran cgroup legyen, ne mindkettő.
