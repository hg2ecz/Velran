...
A frontend expression- és kontrollfolyam-diagnosztika megőrzi a forráspozíciót. Fájlból fordítva a hibának a forrásfájlt és sorszámot is jeleznie kell, nested \code{if}/\code{else}/\code{while} blokkokban is. Ha a compiler rendelkezik helyinformációval, a hely nélküli általános parser-hiba diagnosztikai minőségi hibának számít.
