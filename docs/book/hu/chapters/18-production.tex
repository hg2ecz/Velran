...
A buildelt \code{velran-server} és \code{velran-cli} bináris, az alkalmazásforrás és a migration legyen ugyanahhoz a release-azonosítóhoz köthető. Ne egy élő \code{/srv/velran/current} könyvtár tartalmát módosítsd fájlonként; új immutable release könyvtárat készíts, majd atomikusan válts symlinket.
...
\begin{itemize}
  ...
  \item fájlok közvetlen szerkesztése az aktív release könyvtárban;
