...
\section{Application release workflow: CLI touchpoints}

Chapter 18 defines the deployment contract and Chapter 23 contains the executable production gate; do not maintain a second release checklist here. The CLI-specific touchpoints are deliberately small:
...
Run config-check, backup/recovery, activation, health, smoke, and observability gates around these commands as described in Chapters 18, 19, and 23. Migration \code{apply} is the schema-mutating step and remains a separate approval point.
