...
The renderer is a Velran source module, not an engine directive. It produces typed \code{SafeHtml}; raw HTML is escaped and link targets are restricted by the module plus the generic SafeHtml boundary.
