...
\begin{itemize}
  ...
  \item host disk-space and inode exhaustion on log, AppFs, and database volumes;
  \item public TLS certificate expiry at the terminating edge, and failed renewal jobs where automation is used.
\end{itemize}

For hosts you operate directly, also monitor clock synchronization and the capacity signals of the database/Redis service. Velran metrics describe the application boundary; they do not replace host, proxy, certificate, or database monitoring.
